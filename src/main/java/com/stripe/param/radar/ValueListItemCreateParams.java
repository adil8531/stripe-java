...
public class ValueListItemCreateParams extends ApiRequestParams {
  ...
  private ValueListItemCreateParams(
      List<String> expand, Map<String, Object> extraParams, String value, String valueList) {
    this.expand = expand;
  ...
  public static class Builder {
     ...
     * ValueListItemCreateParams#extraParams} for the field documentation.
     */
     ...
     * See {@link ValueListItemCreateParams#extraParams} for the field documentation.
     */
