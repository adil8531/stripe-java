...
public class InvoiceFinalizeInvoiceParams extends ApiRequestParams {
  ...
  private InvoiceFinalizeInvoiceParams(
      Boolean autoAdvance, List<String> expand, Map<String, Object> extraParams) {
  ...
  public static class Builder {
     ...
     * InvoiceFinalizeInvoiceParams#extraParams} for the field documentation.
     */
     ...
     * See {@link InvoiceFinalizeInvoiceParams#extraParams} for the field documentation.
     */
