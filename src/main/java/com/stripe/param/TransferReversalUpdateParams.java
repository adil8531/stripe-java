...
public class TransferReversalUpdateParams extends ApiRequestParams {
  ...
  public static class Builder {
    ...
    public TransferReversalUpdateParams build() {
      return new TransferReversalUpdateParams(this.expand, this.extraParams, this.metadata);
    }
     ...
     * TransferReversalUpdateParams#extraParams} for the field documentation.
     */
     ...
     * See {@link TransferReversalUpdateParams#extraParams} for the field documentation.
     */
     ...
     * `put/putAll` call, and subsequent calls add additional key/value pairs to the original map.
     * See {@link TransferReversalUpdateParams#metadata} for the field documentation.
     */
    @SuppressWarnings("unchecked")
